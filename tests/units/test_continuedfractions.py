...
class TestContinuedFractionsRational:
	...
	def test_continued_fraction_rational__non_integers__value_error_raised(self, x, y, elements):
...
class TestContinuedFractionReal:
	...
	def test_continued_fraction_real(self, x, elements):
...
class TestFractionFromElements:
	...
	def test_fraction_from_elements__invalid_values__value_error_raised(self, elements):
		with pytest.raises(ValueError):
...
class TestKthConvergent:
	...
	def test_kth_convergent__invalid_values__value_error_raised(self, elements, k):
		with pytest.raises(ValueError):
